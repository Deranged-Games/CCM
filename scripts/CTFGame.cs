...
function CTFGame::initGameVars(%game)
{
    ...
    if( !isDemo() )
    {
       ...
       %game.SCORE_PER_DESTROY_SuperiorityFighter = 9;
...
{ 
   if(%clVictim.headshot && (%damageType == 6 || %damageType == 56 || %damageType == 83 ) && %clVictim.team != %clAttacker.team)
   {
...
function CTFGame::awardScoreVehicleDestroyed(%game, %client, %vehicleType, %mult, %passengers)
{
    ...
    else if(%vehicleType $= "Strike tank")
