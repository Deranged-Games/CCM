...
$packSetting[DispenserDepImage,5,0] = "flameammo pack flamerammopack";
$packSetting[DispenserDepImage,6,0] = "Parachute pack Parachutepack";
$packSetting[DispenserDepImage,7,0] = "Artilery Reloader artilleryWeaponPack";
$packSetting[DispenserDepImage,8,0] = "Medical Pack MedPack";
...
$packSettings[DispenserDepImage,2] = "10 1 Dispenser Pack:[Base Assets]";
...
$packSetting[DispenserDepImage,10,2] = "Door Pack DoorDeployable";
...
$packSetting[DispenserDepImage,5,5] = "Pack Dispenser DispenserDepPack";
$packSetting[DispenserDepImage,6,5] = "Detonation pack DetonationDeppack";
$packSetting[DispenserDepImage,7,5] = "Energize pack EnergizerDeployable";
$packSetting[DispenserDepImage,8,5] = "SpawnPoint pack SpawnPointPack";
$packSetting[DispenserDepImage,9,5] = "Command Satellite SpySatelliteDeployable";
$packSetting[DispenserDepImage,10,5] = "Rack Turret TurretMissileRackDeployable";

$packSettings[DispenserDepImage,6] = "7 1 Dispenser Pack:[Barrels]";
...
$packSettings[DispenserDepImage,7] = "18 1 Dispenser Pack:[Weapons]";
$packSetting[DispenserDepImage,0,7] = "[Cycle packs] cycle";
$packSetting[DispenserDepImage,1,7] = "[Random pack] random";
$packSetting[DispenserDepImage,3,7] = "Machine Gun RPChaingun";
$packSetting[DispenserDepImage,4,7] = "Sniper Gun SniperGun";
$packSetting[DispenserDepImage,5,7] = "Bazooka launcher Bazooka";
$packSetting[DispenserDepImage,6,7] = "SAW MG MG42";
$packSetting[DispenserDepImage,7,7] = "Flame thrower flamer";
$packSetting[DispenserDepImage,8,7] = "Krieg Rifle KriegRifle";
$packSetting[DispenserDepImage,9,7] = "AntiVehicle RocketLauncher AALauncher";
$packSetting[DispenserDepImage,10,7] = "Shot gun shotgun";
$packSetting[DispenserDepImage,11,7] = "Rotary Shotgun Rshotgun";
$packSetting[DispenserDepImage,12,7] = "MP5 MG LSMG";
$packSetting[DispenserDepImage,13,7] = "Colt Pistol pistol";
$packSetting[DispenserDepImage,14,7] = "Construction Tool ConstructionTool";
$packSetting[DispenserDepImage,15,7] = "Nerf Gun NerfGun";
$packSetting[DispenserDepImage,16,7] = "NerfBall Launcher NerfBallLauncher";
$packSetting[DispenserDepImage,17,7] = "Super Chaingun SuperChaingun";
$packSetting[DispenserDepImage,18,7] = "Transport gun Transgun";

$packSettings[DispenserDepImage,8] = "20 1 Dispenser Pack:[Ammo]";
...
$packSetting[DispenserDepImage,16,8] = "FusionMortar Ammo MortarAmmo";
$packSetting[DispenserDepImage,17,8] = "MissileLauncher Ammo MissileLauncherAmmo";
$packSetting[DispenserDepImage,18,8] = "Chaingun Ammo ChaingunAmmo";
$packSetting[DispenserDepImage,19,8] = "NerfBallLauncher Ammo NerfBallLauncherAmmo";
$packSetting[DispenserDepImage,20,8] = "SuperChaingun Ammo SuperChaingunAmmo";
...
$packSetting[DetonationDepImage,1] = "Ion Zap 30";
$packSetting[DetonationDepImage,2] = "Mortar Fountain 30";
$packSetting[DetonationDepImage,3] = "Bomber Crash 30";
$packSetting[DetonationDepImage,4] = "Satchel Charge 30";
$packSetting[DetonationDepImage,5] = "Tactical Nuke 120";
