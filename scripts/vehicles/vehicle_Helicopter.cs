...
datablock ParticleData(WHRocketFireEffectSmoke){
   ...
   colors[0]     = "1.0 0.2 0.0 0.3";
   colors[1]     = "0.3 0.3 0.1 0.2";
...
datablock ParticleEmitterData(WhiteHorseRocketFireEffectEmitter){
   ejectionPeriodMS = 5;
   periodVarianceMS = 0;
   ...
   particles = "WHRocketFireEffectSmoke";
};

datablock ParticleData(WHRocketLaunchEffectSmoke){
   dragCoeffiecient     = 0.4;
   gravityCoefficient   = -0.25;   // rises slowly
   inheritedVelFactor   = 0.025;
...
datablock ParticleEmitterData(WhiteHorseRocketLaunchEffectEmitter){
   ejectionPeriodMS = 1;
   periodVarianceMS = 0;
   ...
   particles = "WHRocketLaunchEffectSmoke";
};
...
datablock SeekerProjectileData(HelicopterMissile)
{
   ...
   baseEmitter         = WhiteHorseRocketFireEffectEmitter;
...
datablock ShapeBaseImageData(HelicopterMissilePairImage)
{
   ...
   stateFire[3] = true;
   stateEmitter[3] = "WhiteHorseRocketLaunchEffectEmitter";
...
function helicopter::onAdd(%this, %obj)
{
   ...
   %obj.setInventory(chaingunammo, 36);
