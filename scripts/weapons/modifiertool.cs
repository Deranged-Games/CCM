...
if (%obj.modifierMode $= "")
   ...
   bottomPrint(%obj.client, "Modifier Tool thanks to Electricutioner and CaptnPower(gained from unofficial v.70 of construction." , 5, 2 );
}
...
if (!((%classname $= "decoration" && %obj.getDataBlock().getname() $="DeployedDecoration6") || %classname $= "crate" || %classname $= "floor" || %classname $= "spine" || %classname $= "mspine" || %classname $= "wall" || %classname $= "wwall" || %classname $= "Wspine" || %classname $= "Sspine" || %classname $= "floor" || %classname $= "door"))
    return;
if (%obj.squaresize !$="")
   return;
%Transform    = %obj.getTransform();
...
if (!((%classname $= "decoration" && %hitobj.getDataBlock().getname() $="DeployedDecoration6") || %classname $= "crate" || %classname $= "floor" || %classname $= "spine" || %classname $= "mspine" || %classname $= "wall" || %classname $= "wwall" || %classname $= "Wspine" || %classname $= "Sspine" || %classname $= "floor" || %classname $= "door"))
    return;
