...
function SinglePlayerGame::equip(%game, %player)
{
   ...
   case 0:
      ...
      %player.setInventory(MGClip,3);
      %player.setInventory(RPChaingunAmmo, 30);
      %player.setInventory(pistol, 1);
      %player.setInventory(pistolAmmo, 10);
      %player.setInventory(pistolClip, 2);
   ...
   case 1:
      ...
      %player.setInventory(ShotgunClip,3);
      %player.setInventory(ShotgunAmmo, 8);
      %player.setInventory(pistol, 1);
      %player.setInventory(pistolAmmo, 10);
      %player.setInventory(pistolClip, 2);
   ...
   case 2: 
      ...
      %player.setInventory(MG42Clip, 2);
      %player.setInventory(MG42Ammo,200);
      %player.setInventory(RShotgun, 1);
      %player.setInventory(RShotgunClip,3);
      %player.setInventory(RShotgunAmmo, 25);
      %player.setInventory(AALauncher, 1);
      %player.setInventory(AALauncherAmmo, 3);
...
//------------------------------------------------------------------------------
function Snipergun::onCollision(%data,%obj, %col)
{
...
//------------------------------------------------------------------------------
function ammopack::onCollision(%data,%obj,%col)
{
   parent::onCollision(%data,%obj,%col);
   ...
   switch(%num)
   {
      ...
      case 3:
		...
		//error(nameToId(MissileCamera));
         ...
         HideHudHack(false);
         toggleCamera(true);
         $MissileLauncherDude.player.use(AALauncher);
